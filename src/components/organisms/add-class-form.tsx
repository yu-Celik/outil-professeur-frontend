...
import { Plus, Check, X, GraduationCap, Hash, Calendar, Save } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid gap-8">
          ...
          <div className="space-y-4">
            <Label htmlFor="schoolYear" className="text-sm font-semibold flex items-center gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-sm">
                  Classe {identifiers.find(i => i.value === identifier)?.label || identifier} - {levels.find(l => l.value === level)?.label || level}
                </p>
                <p className="text-xs text-muted-foreground">
                  Année scolaire: {SCHOOL_YEARS.find(y => y.value === schoolYear)?.label || schoolYear}
                </p>
              </div>
            </div>
          </div>
