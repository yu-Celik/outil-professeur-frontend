/**
 * Hook de gestion des classes (version refactorisée)
      ...
      classCode: [
        ...
        customRule(
          (value: string, items: Class[], excludeId?: string) => {
            ...
            const formData = { classCode: value } as ClassFormData;
...
/**
 * COMPARAISON AVEC L'ANCIEN HOOK:
 * 
 * AVANT: 150+ lignes de code répétitif
 * APRÈS: ~80 lignes avec logique partagée
 * 
 * AVANTAGES:
 * - Élimine la duplication des patterns CRUD
